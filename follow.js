//Really bad follow script for github in phantomjs
//Use at own risk
var system = require('system');
var fs = require('fs');
var loading = false;
var page = new WebPage();
var script_name = 'follow.js';
...
function check_args()
{
	...
	{
		console.log(script_name+' <username> <password> <json file>');
		phantom.exit();
	}
	//Store
...
page.onLoadFinished = function() {
	if (loading)
	{
		...
		switch (currenturl) {
			...
			//check if logged in
			page.render('2.png');
			nexturl = mainurl+usertarget+'/followers';
			setTimeout(function(){ load(nexturl) }, 3000);
			break;
			default:
